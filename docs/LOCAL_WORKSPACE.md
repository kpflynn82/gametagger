...
Requirements: Python 3.11+, uv, Node 22+, npm. FFmpeg/FFprobe enable experimental local MP4 preparation; without them capabilities report it unavailable. This is a single-user local development application, not a production deployment or hosted authentication system.
